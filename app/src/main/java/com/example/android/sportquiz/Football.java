...
public class Football extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTimer();
        countDownText = findViewById(R.id.football_timmer);
        scroll = findViewById(R.id.scrollView);
        endMessage = (TextView) findViewById(R.id.end_message);
        endMessage.setVisibility(View.INVISIBLE);
        home = findViewById(R.id.home_button);
        reset = findViewById(R.id.reset_button);
        q1a1 = findViewById(R.id.football_q1_a1);
        q1a2 = findViewById(R.id.football_q1_a2);
        q1a3 = findViewById(R.id.football_q1_a3);
        q1a4 = findViewById(R.id.football_q1_a4);
        q2a1 = findViewById(R.id.football_q2_a1);
        q2a2 = findViewById(R.id.football_q2_a2);
        q2a3 = findViewById(R.id.football_q2_a3);
        q2a4 = findViewById(R.id.football_q2_a4);
        q3a1 = findViewById(R.id.football_q3_a1);
        q3a2 = findViewById(R.id.football_q3_a2);
        q3a3 = findViewById(R.id.football_q3_a3);
        q3a4 = findViewById(R.id.football_q3_a4);
        q4a1 = findViewById(R.id.football_q4_a1);
        q4a2 = findViewById(R.id.football_q4_a2);
        q4a3 = findViewById(R.id.football_q4_a3);
        q4a4 = findViewById(R.id.football_q4_a4);
        q5a1 = findViewById(R.id.football_q5_a1);
        q5a2 = findViewById(R.id.football_q5_a2);
        q5a3 = findViewById(R.id.football_q5_a3);
        q5a4 = findViewById(R.id.football_q5_a4);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent footballIntent = new Intent(Football.this, Football.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent footballIntent = new Intent(Football.this, MainActivity.class);
                startActivity(footballIntent);
    ...
    public void submitMethod() {
        ...
        if (q1a2.isChecked())
            score += 2;
        if (q2a1.isChecked() && q2a3.isChecked())
            score += 2;
        if (q3a2.isChecked())
            score += 2;
        ...
        if (q5a4.isChecked())
            score += 2;
        endMessage.setText("You finished the Football Quiz!\nYour score is:  " + score + " out of 10!");
    ...
    public void changeBackground() {
        ...
        q2a1.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        q2a3.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        q3a2.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        q4a1.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        q4a3.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        q4a4.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        q5a4.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
        ...
        if (q1a4.isChecked())
            q1a4.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q2a2.isChecked())
            q2a2.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q2a4.isChecked())
            q2a4.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q3a1.isChecked())
            q3a1.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q3a3.isChecked())
            q3a3.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q3a4.isChecked())
            q3a4.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q4a2.isChecked())
            q4a2.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
        if (q5a1.isChecked())
        ...
        if (q5a3.isChecked())
            q5a3.setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
    }
    ...
    public void disable() {
        ...
        q1a4.setTextColor(getResources().getColor(android.R.color.black));
        ...
        q2a4.setTextColor(getResources().getColor(android.R.color.black));
        ...
        q3a4.setTextColor(getResources().getColor(android.R.color.black));
        ...
        q4a4.setTextColor(getResources().getColor(android.R.color.black));
        ...
        q5a4.setTextColor(getResources().getColor(android.R.color.black));
